...
import cvb.com.br.petshop.data.db.dao.util.EntityItemPurchaseFactory
...
class ItemPurchaseDaoTest {
    ...
    fun insertItemPurchase() = runTest {
        ...
        val entityItemPurchaseFromDB = itemPurchaseDao.getItemByPurchaseAndProduct(purchaseId, productId)
    ...
    fun deleteItemPurchase() = runTest {
        ...
        var entityItemPurchaseFromDB = itemPurchaseDao.getItemByPurchaseAndProduct(purchaseId, productId)

        assertThat(entityItemPurchaseFromDB).isNotNull()

        itemPurchaseDao.delete(entityItemPurchase)

        entityItemPurchaseFromDB = itemPurchaseDao.getItemByPurchaseAndProduct(purchaseId, productId)
    ...
    fun getItemPurchase() = runTest {
        ...
        val itemPurchaseFromDB = itemPurchaseDao.getItemByPurchaseAndProduct(2,2)
    ...
    fun getListItemPurchase() = runTest {
        ...
        val listFromDB = itemPurchaseDao.getItemsByPurchase(2)
